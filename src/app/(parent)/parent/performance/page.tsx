...
const PerformancePage = () => {
   ...
   const performanceOverview = {
      ...
      strengthAreas: ["Reading Comprehension", "Geometry", "Historical Analysis"]
   };

   // Subject performance data
   const subjectPerformance = [
      { subject: "Mathematics", average: 88, change: 4.5, lastGrade: "A-", assessments: 4 },
      { subject: "Science", average: 82, change: -1.8, lastGrade: "B+", assessments: 3 },
      { subject: "English", average: 91, change: 2.1, lastGrade: "A", assessments: 5 },
      { subject: "History", average: 79, change: 5.6, lastGrade: "B", assessments: 3 },
      { subject: "Art", average: 95, change: 0, lastGrade: "A", assessments: 2 }
   ];
   ...
   const recentAssessments = [
      { title: "Math Mid-Term Exam", date: "Feb 15, 2025", score: 86, maxScore: 100, subject: "Mathematics" },
      { title: "Book Report: Charlotte's Web", date: "Feb 10, 2025", score: 92, maxScore: 100, subject: "English" },
      { title: "Science Lab: Photosynthesis", date: "Feb 8, 2025", score: 78, maxScore: 100, subject: "Science" },
      { title: "History Quiz: Ancient Egypt", date: "Feb 3, 2025", score: 84, maxScore: 100, subject: "History" }
   ];
         ...
         <div className="w-full space-y-6">
                  ...
                  {children.map((child, index) => (
                     <button 
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-full transition-colors ${
                           selectedChild === index ? "bg-main text-white" : "bg-gray-100 hover:bg-gray-200"
                        }`}
                     >
                        <User size={16} />
                        {child.name}
               ...
               <div className="flex flex-wrap gap-4 items-center justify-between">
                  ...
                  <div className="flex flex-wrap gap-3">
                     <div className="relative">
                        ...
                        <ChevronDown size={16} className="text-gray-500 absolute right-2 top-1/2 transform -translate-y-1/2 pointer-events-none" />
                     </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               ...
               <div className="md:col-span-2 space-y-6">
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                     <div className="flex justify-between items-start mb-6">
                        ...
                        <div className="bg-gray-100 px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1">
                           ...
                           <span>{timeframes.find(t => t.id === selectedTimeframe)?.name}</span>
                        </div>
                     </div>
                     ...
                     <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        <div className="bg-gray-50 p-4 rounded-lg text-center">
                           ...
                           <p className="text-3xl font-bold text-main">{performanceOverview.average}%</p>
                           <div className={`flex items-center justify-center text-sm mt-1 ${
                              performanceOverview.change >= 0 ? "text-green-600" : "text-red-600"
                           }`}>
                              ...
                              <span>{Math.abs(performanceOverview.change)}%</span>
                           </div>
                        </div>
                        
                        <div className="bg-gray-50 p-4 rounded-lg text-center">
                           <p className="text-gray-600 text-sm mb-1">Grade Level</p>
                           <p className="text-xl font-bold text-main">{performanceOverview.gradeLevel}</p>
                        </div>
                        
                        <div className="bg-gray-50 p-4 rounded-lg text-center">
                           <p className="text-gray-600 text-sm mb-1">Class Rank</p>
                           <p className="text-xl font-bold text-main">{performanceOverview.classRank}/{performanceOverview.totalStudents}</p>
                        </div>
                        
                        <div className="bg-gray-50 p-4 rounded-lg text-center">
                           <p className="text-gray-600 text-sm mb-1">Tests Taken</p>
                           <p className="text-xl font-bold text-main">{performanceOverview.testsTaken}</p>
                        </div>
                     </div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                           <h4 className="text-md font-medium mb-3 flex items-center">
                              <Award size={18} className="text-main mr-2" />
                              Strength Areas
                           </h4>
                           <ul className="space-y-2">
                              {performanceOverview.strengthAreas.map((area, index) => (
                        ...
                        <div>
                           <h4 className="text-md font-medium mb-3 flex items-center">
                              <BarChart2 size={18} className="text-main mr-2" />
                              Areas for Improvement
                           </h4>
                           <ul className="space-y-2">
                              {performanceOverview.improvementAreas.map((area, index) => (
                                 <li key={index} className="flex items-center gap-2">
                     ...
                     <div className="h-72">
                        <ResponsiveContainer width="100%" height="100%">
                           ...
                           >
                              ...
                              />
                              <Legend />
                              <Bar dataKey="Score" fill={mainColor} radius={[4, 4, 0, 0]} />
                              <Bar dataKey="ClassAverage" fill="#94a3b8" radius={[4, 4, 0, 0]} />
                           </BarChart>
                        </ResponsiveContainer>
                     </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                     <h3 className="text-lg font-semibold mb-4">Detailed Subject Data</h3>
                        ...
                        <table className="min-w-full">
                           <thead>
                              <tr className="border-b">
                                 ...
                                 <th className="text-center py-3 px-4">Last Grade</th>
                           ...
                           <tbody>
                              {subjectPerformance.map((subject, index) => (
                                 <tr key={index} className="border-b last:border-b-0 hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4 text-center">{subject.average}%</td>
                                    ...
                                    <td className="py-3 px-4 text-center">{subject.lastGrade}</td>
                                    <td className="py-3 px-4 text-center">{subject.assessments}</td>
                                 </tr>
                              ))}
                           </tbody>
                        </table>
               ...
               <div className="space-y-6">
                                 ...
                                 <div className="w-full bg-gray-200 rounded-full h-2">
                                    <div
                                       className={`h-2 rounded-full ${
                                          ...
                                          assessment.score >= 80 ? "bg-main" :
                                          assessment.score >= 70 ? "bg-yellow-500" : "bg-red-500"
                                       }`}
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                     ...
                     <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
                           <RadarChart outerRadius="70%" data={skillRadarData}>
                              <PolarGrid stroke="#e5e7eb" />
                              <PolarAngleAxis dataKey="subject" tick={{ fill: '#6b7280', fontSize: 11 }} />
                              <PolarRadiusAxis domain={[0, 10]} tick={{ fill: '#6b7280' }} />
                              <Radar
                                 name="Skills"
                                 dataKey="A"
                                 stroke={mainColor}
                  ...
                  <div className="bg-white rounded-lg shadow p-6">
                     <h3 className="text-lg font-semibold mb-4">Time Spent by Subject</h3>
                     <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
                           <PieChart>
                              <Pie
                     ...
                     <div className="space-y-4">
                        <div className="bg-gray-50 p-4 rounded-lg">
                           <p className="text-sm italic">
                              "Emma is making excellent progress in most subjects. Her critical thinking skills 
                              have improved significantly this term. I recommend more practice with mathematical 
                              word problems to further strengthen her problem-solving abilities."
                           </p>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                           <p className="text-sm italic">
                              "Emma shows great enthusiasm during science experiments. She should focus on 
                              documenting her observations more thoroughly in her lab reports."
                           </p>
                           <div className="flex justify-between items-center mt-3 text-sm">
