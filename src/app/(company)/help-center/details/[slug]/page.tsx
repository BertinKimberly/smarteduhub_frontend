...
import { ArrowLeft, MessageCircle, ThumbsUp, ThumbsDown, Share, Bookmark, Calendar, Clock, FileText, Shield, User, Search, HelpCircle } from "lucide-react";
...
const HelpCenterDetail = () => {
  ...
  const article = {
    ...
    icon: Shield,
    description: "A comprehensive guide to resetting your password and keeping your account secure.",
    content: [
      {
        type: "paragraph",
  ...
  return (
    <div className="py-10 bg-gray-50 min-h-screen">
      <div className="container mx-auto px-4">
        {/* Navigation */}
        <div className="mb-6">
          <Link href="/help-center" className="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                ...
                {article.content.map((section, index) => (
                  <div key={index} className="mb-6">
                    ...
                    {section.type === "heading" && (
                      <h2 className="text-xl font-bold text-gray-800 mt-8 mb-4">{section.text}</h2>
                    )}
                    
                    {section.type === "steps" && (
                      <ol className="list-decimal pl-6 space-y-2">
                        {section.items.map((item, i) => (
                          <li key={i} className="text-gray-700 pl-2">{item}</li>
                        ))}
                      </ol>
                    )}
                    ...
                    {section.type === "tip" && (
                      <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                        <h3 className="font-semibold text-green-800 mb-1">Tip</h3>
                        <p className="text-green-800">{section.text}</p>
                      </div>
                    )}
                  </div>
                ))}
              ...
              <div className="mt-12 pt-6 border-t border-gray-200">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Was this article helpful?</h3>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
              ...
              <ul className="space-y-3">
                {article.relatedArticles.map((title, index) => (
                  <li key={index}>
                    <Link href={`/help-center/details/${index + 2}`} className="flex items-start gap-2 text-blue-600 hover:text-blue-800">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl shadow-md p-6 text-white">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="opacity-90 mb-4">Our support team is ready to assist you with any questions.</p>
                <Link 
                  href="/contact" 
