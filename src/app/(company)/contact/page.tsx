      ...
      <div className="bg-gradient-to-r from-main to-indigo-600 text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-center text-lg md:text-xl opacity-90 max-w-2xl mx-auto font-light">
            Have questions about our AI-driven learning platform or need support? We're here
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="grid grid-cols-1 gap-4">
              <Card className="p-6 rounded-2xl border-0 shadow-md hover:shadow-lg transition-all duration-300 bg-white">
                <CardContent className="p-0 flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2 text-gray-800">Email Support</h3>
              ...
              <Card className="p-6 rounded-2xl border-0 shadow-md hover:shadow-lg transition-all duration-300 bg-white">
                <CardContent className="p-0 flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2 text-gray-800">Phone Support</h3>
                    <p className="text-gray-600">+1 (555) 123-4567</p>
                    <p className="text-gray-600 text-sm mt-1">Available Mon-Fri: 9:00 - 18:00 ET</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 rounded-2xl border-0 shadow-md hover:shadow-lg transition-all duration-300 bg-white">
                <CardContent className="p-0 flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2 text-gray-800">Live Chat</h3>
                    <p className="text-gray-600">
                      Connect with our support team in real-time through the platform
                    </p>
              ...
              <Card className="p-6 rounded-2xl border-0 shadow-md hover:shadow-lg transition-all duration-300 bg-white">
                <CardContent className="p-0 flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm mt-1">
                      <a href="#" className="text-indigo-600 hover:underline">Visit our Help Center →</a>
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <Card className="mt-8 rounded-2xl overflow-hidden shadow-lg bg-white p-6 border-0">
              <h3 className="font-bold text-xl mb-4 text-gray-800">Smart EduHub Platform</h3>
              <div className="space-y-3">
                <div className="flex items-center">
                  <div className="bg-green-100 p-2 rounded-full mr-3">
                    <Book className="h-4 w-4 text-green-600" />
                  </div>
                  <p className="text-gray-700">Personalized AI Learning Paths</p>
                </div>
                <div className="flex items-center">
                  <div className="bg-green-100 p-2 rounded-full mr-3">
                    <Book className="h-4 w-4 text-green-600" />
                  </div>
                  <p className="text-gray-700">Real-time Progress Tracking</p>
                </div>
                <div className="flex items-center">
                  <div className="bg-green-100 p-2 rounded-full mr-3">
                    <Book className="h-4 w-4 text-green-600" />
                  </div>
                  <p className="text-gray-700">Multi-role Access for Students, Parents & Teachers</p>
                </div>
                <div className="flex items-center">
                  <div className="bg-green-100 p-2 rounded-full mr-3">
                    <Book className="h-4 w-4 text-green-600" />
                  </div>
                  <p className="text-gray-700">Comprehensive Administration Tools</p>
                </div>
              </div>
            </Card>
          </div>
