...
import { 
  Settings, Users, Book, Bell, Shield, 
  Database, Globe, Palette, Mail, Lock,
  ChevronRight
} from 'lucide-react';
  ...
  return (
    ...
    <div className="p-6 w-full">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Manage your Smart EduHub platform configurations</p>
      </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Your platform's display name</p>
                  </div>
                  <Input className="w-48" defaultValue="Smart EduHub" />
                </div>
                <div className="flex justify-between items-center">
                  <div>
                    <h3 className="font-medium">Time Zone</h3>
                    <p className="text-sm text-gray-500">Default platform timezone</p>
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Allow parent account creation</p>
                  </div>
                  <Switch 
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <h3 className="font-medium">Default User Roles</h3>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Enable automatic assignment grading</p>
                  </div>
                  <Switch 
                    checked={autoGrading}
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Enable AI-powered learning assistance</p>
                  </div>
                  <Switch 
                    checked={aiFeatures}
