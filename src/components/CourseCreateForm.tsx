...
const CourseCreateForm: FC<CourseCreateFormProps> = ({ onSuccess }) => {
  ...
  // Materials state
  const [materials, setMaterials] = useState<Array<{ title: string; file: File }>>([]);
          ...
          <div className="grid gap-6">
            <div className="grid gap-3">
              ...
              <Input
                ...
                className={`h-12 ${validationErrors.title ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
              />
            ...
            <div className="grid gap-3">
              ...
              <Textarea
                ...
                className={`min-h-24 ${validationErrors.description ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
              />
            ...
            <div className="grid gap-3">
              <Label htmlFor="longDescription" className="text-base">
                What You'll Learn
              </Label>
              <Textarea
                id="longDescription"
            ...
            <div className="grid gap-3">
              <Label htmlFor="prerequisites" className="text-base">
                Prerequisites
              </Label>
              <Textarea
                id="prerequisites"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="grid gap-3">
                ...
                <Input
                  ...
                  className={`h-12 ${validationErrors.category ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                />
          ...
          <div className="flex justify-end gap-4 mt-8 pt-4 border-t">
            ...
            >
              {createCourseMutation.isPending ? (
                ...
                <>
                  Continue to Materials <ArrowRight className="ml-2 h-4 w-4" />
                </>
              )}
            </Button>
          </div>
        ...
        <TabsContent value="materials" className="space-y-6">
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-medium">Add Course Materials</h3>
            </div>

            <Card className="p-6 border-dashed">
              <div className="grid md:grid-cols-2 gap-4 items-start">
                <div className="space-y-3">
                  <Label htmlFor="materialTitle" className="text-base">Material Title</Label>
                  <Input
                    id="materialTitle"
                ...
                <div className="space-y-3">
                  <Label htmlFor="materialFile" className="text-base">Upload File</Label>
              ...
              <div className="flex justify-end mt-4">
                <Button
                  ...
                  disabled={!currentMaterial.title || !currentMaterial.file}
          ...
          <div className="space-y-4">
            ...
            {materials.length > 0 ? (
                ...
                {materials.map((material, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <span className="font-medium block">{material.title}</span>
                        <span className="text-sm text-gray-500 flex items-center gap-1">
                          {material.file.name} • {getFileSize(material.file)}
                        </span>
                      </div>
                    </div>
                    <Button
              ...
              <div className="text-center py-8 bg-gray-50 rounded-lg border border-dashed">
                ...
                <p className="text-gray-500">Upload course materials to enhance your course.</p>
              </div>
            )}
          </div>
          ...
          <div className="flex justify-between gap-4 mt-8 pt-4 border-t">
            ...
            <Button
              ...
              disabled={uploadMaterialMutation.isPending || materials.length === 0}
              className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-md h-12 px-6"
            >
