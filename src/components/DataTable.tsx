                ...
                table.getRowModel().rows.map((row, i) => (
                  <TableRow
                    ...
                    className={`hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors ${
                      i % 2 === 0 ? "bg-white dark:bg-gray-950" : "bg-gray-50/30 dark:bg-gray-900/30"
                    }`}
                  >
                    {row.getVisibleCells().map((cell) => (
                      <TableCell key={cell.id} className="p-4 text-gray-700 dark:text-gray-300">
                        {flexRender(
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="text-sm text-gray-500 dark:text-gray-400">
              Showing {Math.min(pageIndex * rowsPerPage + 1, data.length)} to{" "}
              {Math.min((pageIndex + 1) * rowsPerPage, data.length)} of {data.length} entries
            </div>
