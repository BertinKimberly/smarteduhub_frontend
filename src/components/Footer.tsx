...
import { Facebook, Instagram, Twitter, ArrowRight, Mail, MapPin, Phone } from "lucide-react";
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-12 border-b border-indigo-800/30">
          ...
          <div className="lg:col-span-4 space-y-6">
            <Link href="/" className="inline-flex items-center">
              ...
              <span className="ml-3 text-xl font-bold text-white">Smart EduHub</span>
            </Link>
            
            <p className="text-indigo-200">
              Revolutionize your learning journey with our AI-powered platform that adapts to your unique pace and style.
            </p>
            
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <MapPin className="h-5 w-5 text-indigo-400" />
                <span className="text-indigo-200">123 Education Ave, Learning City</span>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-5 w-5 text-indigo-400" />
                <span className="text-indigo-200">contact@smarteduhub.com</span>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <p className="text-indigo-200">Stay updated with the latest features, educational tips, and special offers.</p>
        ...
        <div className="py-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center divide-x divide-indigo-700">
            <Link href="/" className="text-indigo-300 hover:text-white text-sm px-4 transition-colors">
              Privacy Policy
            </Link>
            <Link href="/" className="text-indigo-300 hover:text-white text-sm px-4 transition-colors">
              Terms of Service
